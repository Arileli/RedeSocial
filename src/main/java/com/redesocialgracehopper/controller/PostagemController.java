package com.redesocialgracehopper.controller;
...
import com.redesocialgracehopper.repository.PostagemRepository;
...
public class PostagemController {
	...
	public ResponseEntity <List<PostagemEntidade>> GetAll(){
		...
		public ResponseEntity <List<PostagemEntidade>> GetByCategoria(@PathVariable String titulo){
